    ...
    <div class="main-grid clearfix">       
                <div class="grids clearfix">
                    ...
                    <article class="grid triple double-vertical">                      
                      ...
                      <img src="images/photos/easter2.jpg" alt="DINOSAURS ARE STILL ALIVE" />
                      <div class="entry-content">
                        <span class="box-cat">World Wonders</span>
                        <span class="type-post"><i class="fa fa-picture-o"></i></span>
                        <div class="bottom-box">
                         <time datetime="2015-06-05">5 Jun</time>
                         <h3>dinosaurs are still alive</h3>
                         <span class="nickname">orval mendelson</span>
                    ...
                    <article class="grid single" data-type="catalog">                     
                      ...
                      <img src="images/photos/cuban1.jpg" alt="super cars" />
                        <span class="num-cat">10</span>
                        <h5 class="name-cat">Street Life</h5>
                   ...
                   <article class="grid double-vertical">                     
                       <a href="post.html" class="box">
                       <img src="images/photos/wedding6.jpg" alt="pizza" />
                       <div class="entry-content">
                          <span class="box-cat">Weddings</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double-vertical">
                       <a href="post.html" class="box">
                      <img src="images/photos/las-vegas-9558.jpg" alt="people of borough market" />
                        <div class="entry-content">
                    ...
                    <article class="grid double">
                      ...
                      <img src="images/photos/tilt-batad.jpg" alt="mclaren p1" />
                      <div class="entry-content">
                          <span class="box-cat">Weddings</span>
                   ...
                   <article class="grid double">
                    ...
                    <img src="images/photos/milkyway.png" alt="Dubai" />
                    <div class="entry-content">
                          <span class="box-cat">Skylines</span>
                    ...
                    <article class="grid double">
                      <a href="post.html" class="box">
                      <img src="images/photos/island1.png" alt="vibrant hot air balloons" />
                      <div class="entry-content">
                    ...
                    <article class="grid double triple-vertical">
                       ...
                       <img src="images/photos/cubantaxi.jpg" alt="just a big kitty" />
                       <div class="entry-content">
                    ...
                    <article class="grid single" data-type="catalog">
                      <a href="archive.html" class="box">
                    <img src="images/photos/bigcat.png" alt="skylines" />
                        <span class="num-cat">10</span>
                        <h5 class="name-cat">Top Nature</h5>
                        <span class="see-all">see all<i class="fa fa-caret-right"></i></span>
                      </a>
                    </article>
                   ...
                   <article class="grid double-vertical">
                      <a href="post.html" class="box">
                      <img src="images/photos/empire.png" alt="heading out" />
                      <div class="entry-content">
                          <span class="box-cat">Skylines</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double-vertical">
                      <a href="post.html" class="box">
                      <img src="images/photos/cubanglasses.jpg" alt="cyclist" />
                      <div class="entry-content">
                          <span class="box-cat">Nature</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double">
                      <a href="post.html" class="box">
                      <img src="images/photos/metrofinals.jpg" alt="fresh cherry" />
                      <div class="entry-content">
                 ...
                 <div class="grids clearfix">
                    ...
                    <article class="grid single" data-type="catalog">
                      <a href="archive.html" class="box">
                     <img src="images/photos/tibetan.jpg" alt="plants" />
                        <span style="font-size: 10px; color: #FFF; font-weight: 700; text-align: center;z-index: 11;line-height: 0.8;
letter-spacing: -0.1em;">TOP</span>
                        <span class="num-cat">10</span>
                        <h5 class="name-cat">Travel Gadgets</h5>
                        <span class="see-all">see all<i class="fa fa-caret-right"></i></span>
                      </a>
                    </article>
                    ...
                    <article class="grid triple double-vertical">
                      <a href="post.html" class="box">
                      <img src="images/photos/machu-picchu-9805.jpg" alt="SHANGHAI CHINA" />
                      <div class="entry-content">
                          <span class="box-cat">World Wonders</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double-vertical">
                      ...
                      <img src="images/photos/2girls.jpg" alt="Dalai Lama" class="grayscale" />
                      <div class="entry-content">
                          <span class="box-cat">Beaches</span>
                    ...
                    <article class="grid double">
                      <a href="post-media-dark.html" class="box">
                      <img src="images/photos/cubantaxi.jpg" alt="without you" />
                      <div class="entry-content">
                          <span class="box-cat">Nature</span>
                    ...
                    <article class="grid double-vertical">
                      <a href="post.html" class="box">
                      <img src="images/photos/las-vegas-9490.jpg" alt="legends football league australia" />
                      <div class="entry-content">
                    ...
                    <article class="grid double">
                      <a href="post.html" class="box">
                      <img src="images/photos/island1.png" alt="Hawaii" />
                      <div class="entry-content">
                          <span class="box-cat">Beaches</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                 ...
                 <div class="grids clearfix">
                    ...
                    <article class="grid double">
                      <a href="post.html" class="box">
                      <img src="images/photos/nyc1.png" alt="Reflections of Sydney" />
                        <div class="entry-content">
                          <span class="box-cat">Skylines</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double-vertical">
                      <a href="post.html" class="box">
                      <img src="images/photos/birds.png" alt="lemur" />
                      <div class="entry-content">
                          <span class="box-cat">Nature</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double triple-vertical">
                       <a href="post.html" class="box">
                       <img src="images/photos/humming.png" alt="PURPLE CROCUSES" />
                       <div class="entry-content">
                          <span class="box-cat">Nature</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double-vertical">
                      ...
                      <img src="images/photos/empire.png" alt="FRESH FRUIT MIX" />
                      <div class="entry-content">
                          <span class="box-cat">Skylines</span>
                          <span class="type-post"><i class="fa fa-th-large"></i></span>
                          <div class="bottom-box">
                    ...
                    <article class="grid double">
                     <a href="post.html" class="box">
                      <img src="images/photos/wedding2.jpg" alt="AUDI R" />
                      <div class="entry-content">
                          <span class="box-cat">Weddings</span>
                          <span class="type-post"><i class="fa fa-picture-o"></i></span>
                          <div class="bottom-box">
